<#
.SYNOPSIS
    Retrieves Intune configuration profiles for a given platform.

.DESCRIPTION
    This function fetches configuration profiles from Microsoft Graph filtered by platform or returns all profiles.

.PARAMETER Platform
    One of Windows, macOS, Android, or iOS.

.PARAMETER All
    If specified, returns all profiles regardless of platform.

.PARAMETER AllProperties
    Include all available properties in output (uses beta endpoints).
